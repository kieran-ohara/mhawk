...
const getFinitePaymentPlans = async () => getPaymentPlans((params) => `WHERE ${params.plansTableName}.end_date IS NOT NULL`);
const getRecurringPaymentPlans = async () => getPaymentPlans((params) => `WHERE ${params.plansTableName}.end_date IS NULL`);
...
//     return `
//         WHERE (DATE('${dateAsString}') BETWEEN ${params.plansTableName}.start_date
//         AND ${params.plansTableName}.end_date)
//         OR (${params.plansTableName}.start_date <= '${dateAsString}'
//         AND ${params.plansTableName}.end_date IS NULL)
//         `;
//   });
